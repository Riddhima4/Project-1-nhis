...
val=" "
data=StringVar()
display=Entry(root,textvariable=data,bd=29,justify="right",bg="lightcoral",font=("ariel",20))
...
btn_mul=Button(root,text="x",font=("ariel",12,"bold"),bd=12,height=2,width=6,command=lambda:btnclick("x"))
